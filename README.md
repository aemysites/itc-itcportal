...
## Environments
- Preview: https://main--itc-itcportal--aemysites.aem.page/
- Live: https://main--itc-itcportal--aemysites.aem.live/
- Block Library: https://main--itc-itcportal--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-itcportal` directory in your favorite IDE and start coding :)
